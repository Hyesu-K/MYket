...
<body>
<form action="pass.me" method="post" name="f" onsubmit="return inputcheck(this)">
<table>
	<caption>비밀번호 찾기</caption>
 	<tr><td class="th">아이디</td><td class="td"><input type="text" name="id"></td></tr>
 	...
 	<tr><td colspan="2"><input class="btn_submit" type="submit" value="비밀번호찾기"></td></tr>
</table>
</form>
</body>
</html>